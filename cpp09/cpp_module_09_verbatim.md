...
Your program must use the merge-insert sort algorithm (Ford-Johnson).

You must use at least two different containers.
...
• The sorted sequence  
• The time taken with the first container  
• The time taken with the second container  
